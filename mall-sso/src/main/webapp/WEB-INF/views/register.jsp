...
<link type="text/css" rel="stylesheet"
	href="${staticUrl}/css/passport.base.css" />
...
function addToFavorite() {
			...
			<form id="personRegForm" method="post" onsubmit="return false;">
				...
				<div class="phone">
					<img width="180" height="180"
						src="${staticUrl}/images/phone-bg.jpg">
				</div>
				<span class="clr"></span>
			</form>
		</div>
	...
	<script type="text/javascript"
		src="${staticUrl}/js/register/jdThickBox.js"></script>
	<script type="text/javascript"
		src="${staticUrl}/js/register/jdValidate.js"></script>
	<script type="text/javascript"
		src="${staticUrl}/js/register/jdValidate.emReg.js"></script>
	<script type="text/javascript"
